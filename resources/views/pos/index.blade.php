                        ...
                        <div class="d-flex border-bottom pb-3">
                            <div class="flex-grow-1">
                                <select name="user_id" class="form-control aiz-selectpicker pos-customer" data-live-search="true" onchange="getShippingAddress()">
                                    <option value="">{{translate('Walk In Customer')}}</option>                                       											<option value="">{{translate('Order From Facebook')}}</option>
                                        <option value="">{{translate('Order From Whatsapp')}}</option>
                                        <option value="">{{translate('Order From Instagram')}}</option>                                        										   <option value="">{{translate('Order From IMO')}}</option>
