    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col">
                <p class="wlcTxt" style="color:#04396C !important; font-family: cursive;">Welcome to Sahebzaadi, Find your Desire Heads & Wraps</p>
...
<!-- END Top Bar -->
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020  border-bottom shadow-sm" style="background-color:#fff !important;">
    <!--bg-dark-->
                        ...
                        <div class="d-none d-xl-block align-self-stretch category-menu-icon-box ml-auto mr-0">
                            <div class="h-100 d-flex align-items-center" id="category-menu-icon">
                                <div class="dropdown-toggle navbar-light bg-light h-40px w-50px pl-2 rounded border c-pointer">
                                    ...
                                    <span class="pix_cat">Categories</span>
                                </div>
                            </div>
                        </div>
                    @endif
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="border-top border-gray-200 py-1" style="background-color:#04396C!important;">
            <!--bg-white -->
            <div class="container">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="{{ json_decode( get_setting('header_menu_links'), true)[$key] }}" class="deco  fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-80 text-reset">
                            <!--opacity-60-->
                            {{ translate($value) }}
                        </a>
                    </li>
