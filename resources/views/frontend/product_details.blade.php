                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto ml">
                                    <small class="mr-2 opacity-80">{{ translate('Estimate Shipping Time')}}: </small>{{ $detailedProduct->est_shipping_days }} {{  translate('Days') }}
                                </div>
                                @endif
                                
                                
                                @if ($detailedProduct->phone)
                                <div class="col-auto ml">
                                    <small class="mr-2 opacity-80">{{ translate('Call Us')}}: </small>+880{{ $detailedProduct->phone }} 
                                </div>
                                @endif
