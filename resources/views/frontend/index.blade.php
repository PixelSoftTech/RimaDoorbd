        ...
        <div class="container">
            <div class="row gutters-10 position-relative">
                <div class="col-lg-3 position-static d-none d-lg-block">
                    @include('frontend.partials.category_menuedited')
                </div>
                ...
                <div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-9 @endif">
                    ...
                    <!-- HARD CODED FEATURED CATEGORIES -->
                    
                   
                        <!--<ul class="list-unstyled mb-0 row gutters-5">-->
                          
                        <!--        <li class="minw-0 col-4 col-md mt-3">-->
                        <!--            <a href="https://nirmanbazar.softcreation.tech/category/solution-for-vi42t" class="d-block rounded bg-white p-2 text-reset shadow-sm">-->
                        <!--                <img-->
                        <!--                    src="{{asset('public/assets/featured_category/solution.jpg')}}"-->
                                            
                        <!--                    class="lazyload img-fit"-->
                        <!--                    height="78"-->
                                           
                        <!--                >-->
                        <!--                <div class="text-truncate fs-12 fw-600 mt-2 opacity-70">Solution For</div>-->
                        <!--            </a>-->
                        <!--        </li>-->
                        <!--          <li class="minw-0 col-4 col-md mt-3">-->
                        <!--            <a href="https://nirmanbazar.softcreation.tech/category/solution-for-vi42t" class="d-block rounded bg-white p-2 text-reset shadow-sm">-->
                    ...
                    <!--  HARD CODED FEATURED CATEGORIES ENDS -->
                </div>
