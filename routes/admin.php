...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/requirementindex', 'StaffController@requiremtIndex')->name('requirementindex');
     Route::get('requirementdelete/{id}', 'StaffController@requirementdelete')->name('requirementdelete');
     Route::get('itemadd', 'StaffController@itemadd')->name('itemadd');
    Route::post('itemadds', 'StaffController@itemadds')->name('itemadds');
    Route::get('allitem', 'StaffController@allitem')->name('allitem');
     Route::get('itemdelete/{id}', 'StaffController@itemdelete')->name('itemdelete');
