...
Route::get('/request_product','BlogController@requestpage')->name('request_product');
Route::post('request_product','BlogController@requestproduct');
Route::get('showproduct','StaffController@showrequestproduct')->name('showproduct');
Route::get('delete/{id}','StaffController@delete')->name('delete');
Route::get('edit/{id}', [StaffController::class,'edits'])->name('edits');
Route::post('updatedata/{id}', 'StaffController@updatedata')->name('updatedata');
Route::get('orderstatus', 'BlogController@orderstatus')->name('orderstatus');
...
Route::get('/Postrequirment', 'BlogController@Postrequirment')->name('Postrequirment');
Route::post('/addPostrequirment', 'BlogController@addPostrequirment')->name('addPostrequirment');
Route::get('/calculator', 'BlogController@calculator')->name('calculator');
